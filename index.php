...
<head>
    ...
    <title>🔥 SAJT NA PRODAJU - Piljenje Drva Zagreb - Rangira se kao #1 | 150€/godišnje</title>
    <meta name="description" content="⭐ SAJT NA PRODAJU - 150€ godišnje! Rangira se kao #1 za 'piljenje drva zagreb'. SEO optimizovan šablon web sajta za piljenje drva. Profesionalno dizajniran, spremno za upotrebu. Kontakt: svilenkovic.com">
    <meta name="keywords" content="piljenje drva zagreb, piljenje drva za ogrjev, piljenje drva hrvatska, piljenje drva zagrebačka županija, piljenje drva na terenu, piljenje drva bukva hrast, piljenje drva motorne pile, piljenje drva trakne pile, piljenje drva cijena, šablon web sajta">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://piljenjedrva.svilenkovic.com/">
    <meta property="og:title" content="🔥 SAJT NA PRODAJU - Piljenje Drva Zagreb - Rangira se kao #1">
    <meta property="og:description" content="⭐ SAJT NA PRODAJU - 150€ godišnje! Rangira se kao #1 za 'piljenje drva zagreb'. SEO optimizovan web sajt spremno za upotrebu.">
    ...
    <meta property="twitter:title" content="🔥 SAJT NA PRODAJU - Piljenje Drva Zagreb">
    <meta property="twitter:description" content="⭐ SAJT NA PRODAJU - 150€ godišnje! Rangira se kao #1 za 'piljenje drva zagreb'.">
...
<body class="bg-cream text-bark">
            ...
            <div class="text-center fade-in">
                <div class="mb-8">
                    <i class="fas fa-saw text-6xl mb-6 text-leaf"></i>
                     ...
                     Piljenje Drva Zagreb - Šablon
                 </h1>
                 <p class="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed">
                     Profesionalna usluga piljenja drva za ogrjev u Zagrebu i okolici. Brzo, povoljno i sigurno! Dolazimo na vašu adresu sa svom opremom. Ovo je šablon web sajta.
                 </p>
    ...
    <section id="kontakt" class="py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600">
                    Zainteresovani ste za ovaj šablon?
                </p>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-100 to-emerald-100 border-l-4 border-green-500 rounded-lg p-6 mb-12 fade-in">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-bold text-green-800">Ovo je Demo Šablon</h3>
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden fade-in">
                <div class="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-8 px-8 text-center">
                    ...
                    <p class="text-green-100">Naručite Piljenje Drva Šablon već danas!</p>
                </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-10">
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 text-center border-2 border-green-200">
                            <div class="text-sm font-semibold text-gray-600 uppercase mb-2">Godišnja Najam</div>
                            <div class="text-5xl font-black text-green-600 mb-2">150€</div>
                            <div class="text-sm text-gray-600">+ hosting (oko 50€/god)</div>
                        </div>
                    ...
                    <!-- Contact Options -->
                    <h3 class="text-xl font-bold text-gray-800 mb-6 text-center">Kontaktirajte nas za narudžbinu:</h3>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 mb-8">
                        ...
                        <a href="https://svilenkovic.com/webshop.php" target="_blank" 
    ...
    <!-- SAJT NA PRODAJU CTA Section -->
    <section class="py-16 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 border-y-4 border-orange-400">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-red-600 via-orange-500 to-yellow-500 text-white py-6 px-8">
                    <h2 class="text-3xl md:text-4xl font-bold text-center">
                        🔥 Ovaj Sajt Je Na Prodaju! 🔥
                    </h2>
                </div>
                <div class="p-8 md:p-12">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            <h3 class="text-2xl font-bold text-bark mb-4">Zašto Kupiti Ovaj Sajt?</h3>
                            <ul class="space-y-3 text-gray-700">
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>Rangira se kao #1</strong> za ključne reči "piljenje drva zagreb" i slične termine</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>SEO Optimizovan</strong> - Vrhunsko rangiranje u Google pretrazi</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>Responsive Dizajn</strong> - Savršeno radi na svim uređajima</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>Spremno za upotrebu</strong> - Samo promeni kontakt info i kreni!</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>Profesionalan dizajn</strong> - Moderno i privlačno</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span><strong>Kontakt forma</strong> - Automatsko slanje emailova</span>
                                </li>
                            </ul>
                        </div>
                        <div class="text-center">
                            <div class="bg-gradient-to-br from-red-100 to-orange-100 rounded-xl p-8 mb-6">
                                <div class="text-sm font-semibold text-gray-700 uppercase mb-2">Godišnja Cena</div>
                                <div class="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500 mb-2">
                                    150€
                                </div>
                                ...
                                <div class="mt-4 text-xs text-gray-500">
                                    * Jednokratna uplata za godinu dana korišćenja sajta
                                </div>
                            </div>
                            <a href="https://svilenkovic.com/contact.php" target="_blank" class="inline-block bg-gradient-to-r from-red-600 to-orange-500 text-white px-8 py-4 rounded-xl text-xl font-bold hover:from-red-700 hover:to-orange-600 transition-all transform hover:scale-105 shadow-xl">
                                <i class="fas fa-shopping-cart mr-2"></i>
                                Kupi Sajt Odmah
                            </a>
                            <div class="mt-6 space-y-2 text-sm text-gray-600">
                                <p><i class="fas fa-globe mr-2 text-orange-500"></i> <a href="https://svilenkovic.com" target="_blank" class="font-bold hover:text-orange-500">svilenkovic.com</a></p>
                                <p><i class="fas fa-envelope mr-2 text-orange-500"></i> <a href="mailto:dimitrije@svilenkovic.com" class="font-bold hover:text-orange-500">dimitrije@svilenkovic.com</a></p>
                                <p><i class="fas fa-phone mr-2 text-orange-500"></i> <a href="tel:+381612248989" class="font-bold hover:text-orange-500">+381 61 224 8989</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-8 p-6 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg">
                        <p class="text-sm text-gray-700">
                            ...
                            <strong>Napomena:</strong> Nakon kupovine dobijate kompletne fajlove sajta, pristup hostingu, i mogućnost besplatne tehničke podrške prvih 30 dana. 
                            Mogu vam pomoći sa podešavanjem i prilagodbom sajta za vaše potrebe.
                        </p>
                    </div>
                </div>
            </div>
     ...
     <footer class="bg-bark text-white py-8">
         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
             <p>&copy; 2025 Piljenje drva Zagreb - Šablon</p>
                          <p class="mt-2 text-sm text-gray-300">Profesionalna usluga piljenja drva za ogrjev - Šablon web sajta</p>
    ...
    <div class="fixed bottom-6 right-6 z-50 animate-bounce">
        <a href="viber://chat?number=+381612248989" target="_blank" class="block">
            <div class="bg-gradient-to-br from-red-600 to-orange-600 text-white rounded-full p-6 shadow-2xl hover:scale-110 transition-transform cursor-pointer border-4 border-white badge-pulse">
                <div class="text-center">
                    <div class="text-sm font-bold uppercase mb-1">Sajt</div>
                    <div class="text-sm font-bold uppercase mb-2">Na Prodaju</div>
                    <div class="text-3xl font-black">150€</div>
                    <div class="text-xs font-semibold">godišnje</div>
                    <div class="mt-2 text-xs">
                        <i class="fas fa-shopping-cart"></i> Kupi
                    </div>
                </div>
            </div>
        </a>
